...
using SerializerExtension = JohnChum.SharedKernel.Extensions.SerializerExtension;
using JohnChum.SharedKernel.SpecificationQuery.LHS.Common.Exceptions;

namespace JohnChum.SharedKernel.SpecificationQuery.LHS.Common.QueryStringProcessing;
...
public static partial class QueryParamValidate
{
    ...
    private static bool ValidateArrayOperatorInvalidIndex(List<string> input)
    {
        ...
        if (!input.Any(x => arrayOperators.Contains(x)))
        {
            return true;
        }
