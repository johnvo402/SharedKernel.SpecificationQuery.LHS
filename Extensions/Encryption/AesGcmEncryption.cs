...
namespace JohnChum.SharedKernel.SpecificationQuery.LHS.Extensions.Encryption;
...
public class AesGcmEncryption
{
    ...
    public static string Encrypt(string text, string base64key, string? authenticationTag = null)
    {
        ...
        return ToBase64UrlSafe(encryptedText);
    }
    ...
    {
        byte[] encryptedTextBytes = FromBase64UrlSafe(encryptedText);
    ...
    private static byte[] FromBase64UrlSafe(string base64Url)
    {
        string base64 = base64Url
            .Replace('-', '+') // Chuyển '-' về '+'
            .Replace('_', '/'); // Chuyển '_' về '/'
